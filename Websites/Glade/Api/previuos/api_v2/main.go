...
func insertData(w http.ResponseWriter, r *http.Request) {
	...
	respond.With(w, r, http.StatusOK, "Inserted succesfully")
}
...
func checkData(w http.ResponseWriter, r *http.Request) {
	...
	var respondValues respondValues

	respondValues.emailResult = emailResult
	respondValues.userResult = userResult
	respondValues.passwordResult = passwordResult

	respond.With(w, r, http.StatusOK, respondValues)
}
